...
namespace Trading.Common_Tests
{
    ...
    public class Bar_Tests
    {
        ...
        {
            Bar bar1 = new Bar(30, 100, 20, 50, 0, DateTime.Now);
        ...
        {
            Bar bar1 = new Bar(50, 100, 20, 30, 0, DateTime.Now);
        ...
        {
            Bar DownBar = new Bar(50, 100, 20, 30, 0, DateTime.Now);
            Bar UpBar = new Bar(70, 120, 50, 80, 0, DateTime.Now, DownBar);
        ...
        {
            Bar DownBar = new Bar(50, 100, 20, 30, 0, DateTime.Now);
            Bar UpBar = new Bar(150, 200, 110, 170, 0, DateTime.Now, DownBar);
        ...
        {
            Bar UpBar = new Bar(70, 120, 50, 80, 0, DateTime.Now);
            Bar DownBar = new Bar(50, 100, 20, 30, 0, DateTime.Now, UpBar);
        ...
        {
            Bar UpBar = new Bar(70, 120, 50, 80, 0, DateTime.Now);
            Bar DownBar = new Bar(20, 40, 5, 10, 0, DateTime.Now, UpBar);
        ...
        {
            Bar DownBar = new Bar(50, 100, 20, 30, 0, DateTime.Now);
            Bar UpBar = new Bar(60, 120, 10, 70, 0, DateTime.Now, DownBar);
        ...
        {
            Bar UpBar = new Bar(70, 120, 50, 80, 0, DateTime.Now);
            Bar DownBar = new Bar(60, 130, 10, 50, 0, DateTime.Now, UpBar);
