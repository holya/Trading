...
namespace Trading.DataBases_Tests
{
    ...
    public class XmlDataBase_Tests
    {
        ...
        public void WriteData_Stock()
        {
            ...
            var rbs = tb.ReadLocalData(instrument, resolution, barList.First().DateTime, barList.Last().EndDateTime);
        ...
        public void WriteData_Forex()
        {
            ...
            tb.WriteLocalData(instrument, new Resolution(TimeFrame.Hourly, 1), barList);
            var rbs = tb.ReadLocalData(instrument, new Resolution(TimeFrame.Hourly, 1), barList.First().DateTime, barList.Last().EndDateTime);
        ...
        public void PrependData()
        {
            ...
            barList.Add(new Bar(10, 20, 5, 12, 0, firstDt, firstDt.AddMinutes(5)));
            barList.Add(new Bar(15, 25, 10, 17, 0, firstDt.AddMinutes(5), firstDt.AddMinutes(10)));
            barList.Add(new Bar(15, 27, 8, 17, 0, firstDt.AddMinutes(10), firstDt.AddMinutes(15)));
            ...
            barList.Clear();
            barList.Add(new Bar(1, 20, 5, 12, 0, firstDt.AddMinutes(-60), firstDt.AddMinutes(-55)));
            barList.Add(new Bar(0, 25, 10, 17, 0, firstDt.AddMinutes(-55), firstDt.AddMinutes(-50)));
            barList.Add(new Bar(0, 27, 8, 17, 0, firstDt.AddMinutes(-50), firstDt.AddMinutes(-45)));
            tb.PrependLocalData(instrument, resolution, barList);

            var rbs = tb.ReadLocalData(instrument, resolution, firstDt.AddMinutes(-60), firstDt.AddMinutes(15));
